{
  ...
  outputs =
    ...
    rec {
      ...
      legacyPackages = utils.forAllSystems (
        system:
      ...
      formatter = utils.forAllSystems (system: legacyPackages.${system}.nixfmt-rfc-style);
      ...
      packages = utils.forAllSystems (system: (import ./packages { pkgs = legacyPackages."${system}"; }));

      nixosConfigurations = {
        monke = inputs.nixpkgs.lib.nixosSystem (
          nixos.mkNixosModule {
            hostname = "monke";
            system = "x86_64-linux";
      ...
      darwinConfigurations = {
        "markbook" = inputs.darwin.lib.darwinSystem (
          darwin.mkDarwinModule {
            hostname = "markbook";
